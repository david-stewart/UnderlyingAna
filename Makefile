...
$(ODIR)/Unfold2D.o 	 	: $(SDIR)/Unfold2D.cxx $(INCS) $(SDIR)/Unfold2D.hh
$(ODIR)/MaxTrackUnderlyingAna.o 	 	: $(SDIR)/MaxTrackUnderlyingAna.cxx $(INCS) $(SDIR)/MaxTrackUnderlyingAna.hh
...
$(BDIR)/PicoUnderMcVsEmbed		: $(ODIR)/PicoUnderMcVsEmbed.o		$(ODIR)/underlying_McVsEmbed.o	 	lib/libMyJetlib.so
$(BDIR)/PicoMaxTrackUnderlyingActivity		: $(ODIR)/PicoMaxTrackUnderlyingActivity.o		$(ODIR)/MaxTrackUnderlyingAna.o	 	lib/libMyJetlib.so
...
$(BDIR)/MainUnfold2D		: $(ODIR)/MainUnfold2D.o	$(ODIR)/Unfold2D.o	 	
